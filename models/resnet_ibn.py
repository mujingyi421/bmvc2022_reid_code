...
class ResNet_IBN(nn.Module):
    ...
    def __init__(self, last_stride, block, layers):
        ...
        self.bnn = nn.BatchNorm1d(2048)   
        init.normal_(self.bnn.weight.data, 1.0, 0.02)
        init.constant_(self.bnn.bias.data, 0.0)
...
def resnet50_ibn_a(last_stride, pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet50_ibn_a']), strict=False)
    return model
