...
_C.MODEL.RESUME = '' ############################################ or './logs/prcc_mask/res50-ce-triplet/checkpoint_ep24.pth.tar'
# -----------------------------------------------------------------------------
# Losses for training 
# -----------------------------------------------------------------------------
_C.LOSS = CN()
...
_C.LOSS.CLA_M = 0.
# Pairwise loss
_C.LOSS.PAIR_LOSS = 'triplet_prcc'
# Scale
_C.LOSS.PAIR_S = 16.
# Margin
_C.LOSS.PAIR_M = 0.3
...
def update_config(config, args):
    ...
    # output folder
    config.OUTPUT = os.path.join(config.OUTPUT, config.DATA.DATASET, config.TAG, 'ps_cc') #############
